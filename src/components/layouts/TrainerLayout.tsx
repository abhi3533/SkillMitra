...
import { LayoutDashboard, BookOpen, Users, Calendar, DollarSign, Award, TrendingUp, User, LogOut, Menu, X, Bell } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      <header className="fixed top-0 left-0 right-0 z-40 bg-card border-b h-16 flex items-center px-4 lg:px-8">
        ...
        <div className="w-8 h-8 rounded-full gold-gradient flex items-center justify-center">
          <span className="text-accent-foreground text-xs font-bold">{profile?.full_name?.[0] || "T"}</span>
        </div>
      </header>
