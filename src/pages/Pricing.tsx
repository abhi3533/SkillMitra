...
const Pricing = () => {
  usePageMeta({
    title: "Pricing — Affordable Skill Training on SkillMitra",
    description: "Course fees starting ₹999/month. Trainer plans: Basic (Free), Pro (₹999/mo), Elite (₹2,499/mo). Start with a free trial.",
  });
  return (
