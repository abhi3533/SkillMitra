...
const TrainerDashboard = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    await (async () => {
      ...
      if (trainer.onboarding_status === "draft" || trainer.onboarding_status === "registered" || (trainer.onboarding_step !== null && trainer.onboarding_step < 3 && trainer.onboarding_status !== "pending")) {
      ...
      {onboardingInfo && (onboardingInfo.status === "draft" || onboardingInfo.status === "registered") && !loading && data.approvalStatus !== "approved" && (
        <div className="mt-4 bg-primary/5 border border-primary/20 rounded-xl p-4 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">Step {onboardingInfo.step + 1} of 3 left. Complete your profile so students can find you.</p>
