...
const ReferralSignupReferrerEmail = ({ referrerName, referredName, rewardAmount = 500 }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Someone used your referral code on {SITE_NAME}!</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={contentSection}>
          <Text style={h3}>Someone used your referral code! 🎉</Text>
          <Text style={text}>
            Hi{referrerName ? ` ${referrerName}` : ''}, {referredName || 'a new student'} signed up using your referral code.
            You'll earn <strong>₹{rewardAmount}</strong> when they complete their first enrollment!
          </Text>
          <div style={highlightBox}>
            <Text style={highlightText}>
              💰 <strong>₹{rewardAmount} bonus</strong> will be credited to your wallet once {referredName || 'they'} complete{referredName ? 's' : ''} their first paid enrollment.
            </Text>
          </div>
          <table cellPadding="0" cellSpacing="0" role="presentation" style={{ width: '100%', margin: '24px 0' }}>
            <tr>
              <td style={{ textAlign: 'center' }}>
                <Button href={`${SITE_URL}/student/referrals`} style={button}>
                  View My Referrals
                </Button>
              </td>
            </tr>
...
export const template = {
  component: ReferralSignupReferrerEmail,
  subject: 'Someone used your referral code!',
  displayName: 'Referral signup — referrer notification',
  previewData: { referrerName: 'Priya', referredName: 'Rahul', rewardAmount: 500 },
...
const highlightBox = { background: '#fef3c7', border: '1px solid #fcd34d', borderRadius: '8px', padding: '16px', margin: '16px 0' }
const highlightText = { fontSize: '14px', color: '#92400e', margin: '0', lineHeight: '1.5' }
